...
export class Statistics extends Component {
  ...
  render() {
    return (
      <Col span={16} className={styles.statistics}>
        <Col span={8} className={styles.amount} >{this.state.all_interface_count}</Col>
        <Col span={7} className={styles.today_amount}><img src="src/images/up_icon.svg" alt="" className={styles.up_icon} />{this.state.today_interface_count}</Col>
